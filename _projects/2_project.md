...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/2.jpg" title="Near-field UAV localization" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    System model for near-field ISAC-enabled UAV localization.
</div>
