...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/3.jpg" title="ODDM-ISAC systems" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    ODDM-ISAC system architecture and signal processing chain.
</div>
