...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/4.jpg" title="DOA estimation" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    MIMO ISAC system for DOA estimation with nonorthogonal waveforms.
</div>
