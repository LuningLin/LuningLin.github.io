    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: 'Awarded the National Scholarship (2025).',
          description: "",
          section: "News",},{id: "projects-isac-waveform-design",
          title: 'ISAC Waveform Design',
          description: "Joint waveform design for dual-function radar-communication systems",
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_project/";
            },},{id: "projects-near-field-uav-localization",
          title: 'Near-Field UAV Localization',
          description: "ISAC-enabled high-mobility UAV localization in near-field regions",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_project/";
            },},{id: "projects-oddm-isac-systems",
          title: 'ODDM-ISAC Systems',
          description: "Joint target localization and channel estimation for ODDM-based ISAC",
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_project/";
            },},{id: "projects-doa-estimation",
          title: 'DOA Estimation',
          description: "Nonorthogonal waveform assisted DOA estimation for MIMO sensing and communication",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%75%6E%69%6E%67%6C%69%6E@%7A%6A%75.%65%64%75.%63%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/LuningLin", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
